...
export const Hub: React.FC<Props> = ({ onSelectModule, onOpenLog, onStartTest, onStartBoss, onStartTrial }) => {
  ...
  const bossUnlocked = isThemeUnlocked('speedworld', badgeRatioValue);
  ...
  return (
    <div className="w-full h-full overflow-y-auto">
      <div className="max-w-6xl mx-auto px-6 py-6">
        ...
        {/* ボス戦（スピードワールド以上で解放されるスペシャルステージ。あえて一番下に置く） */}
        <motion.button
        ...
        <div className="mt-6">
          <TrialCard appId="gaisu" floors={FLOOR_COUNT} onClick={onStartTrial} />
        </div>
      </div>
